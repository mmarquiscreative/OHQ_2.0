<div class="row">
    ...
    <div id="form-container">
      <div class="page-header text-center">
        ...
        <div id="status-buttons" ng-class="stage.testBool('intro') || stage.testBool('exit') ? 'hidden' : 'text-center nav'">
          ...
          <img class="agx-hearing-logo logo-stage" src="/wp-content/plugins/OHQ_2.0/img/AGX-Hearing-Color.png" />
 ...
 Double Streaming 
   ...
   <audio id="doubleBGNoise" src="/wp-content/plugins/OHQ_2.0/sounds/SpeechTest_OHQ_Noise_Lvl1.mp3"></audio>
   <audio id="doubleWord" src="/wp-content/plugins/OHQ_2.0/sounds/SpeechTest_OHQ_Word_Bean.mp3"></audio>
   -->
